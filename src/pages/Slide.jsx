...
import { Link, useNavigate } from 'react-router-dom'; // Line 4
            ...
            <Carousel
                ...
                itemClass="carousel-item-padding-40-px">
                {
                    products.map((product, index) => (
                        // Updated Link component import
                        <Link key={index} to={`/product/view/${product._id}`} style={{ textDecoration: 'none' }}> // Line 36
