...
const CustomerSearch = ({ mode }) => {
    ...
    const handleSearch = (event) => { // Fixed: Added `event` parameter to handleSearch function
        event.preventDefault(); // Fixed: Changed `preventDefault` to `event.preventDefault()`
