...
import { Box, Grid } from '@mui/material'; // Added imports for Box and Grid
            ...
            responseSellerProducts ?
              ...
              <>
                {Array.isArray(sellerProductData) && sellerProductData.length > 0 &&
                  <ProductGrid container spacing={3}> {/* Fixed Grid usage */}
...
const ProductGrid = styled(Grid)`  // Fixed Grid usage
  display: flex;
  align-items: center;
`;
